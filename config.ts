...
export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an AI assistant created by ${OWNER_NAME}. I help analyze Pokémon trading card products.

⚠️ Disclaimer:
- Responses are generated by an AI system and may be inaccurate or incomplete.
- This assistant does not provide financial, investment, or professional advice.
